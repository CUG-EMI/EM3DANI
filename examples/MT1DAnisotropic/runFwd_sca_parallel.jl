...
# scattered/secondary-field approach in parallel mode
#---------------------------------------------------------------------------------
...
# to be given
# background model No.1
#refModel = RefModel(zeros(5), zeros(5))
#refModel.sig1D   = [1e-8, 1e-4, 1.0/200, 1e-3, 0.01]
#refModel.depth1D = [-emMesh.origin[3], 0, 10000., 28000, 128000]

# background model No.2
refModel = RefModel(zeros(2), zeros(2))
refModel.sig1D   = [1e-8, 1e-4]
...
respfile = "31Freqs_RhoPhs_BGM2_QMR_np16.resp"
